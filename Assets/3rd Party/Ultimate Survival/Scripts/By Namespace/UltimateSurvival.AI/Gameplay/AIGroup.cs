...
namespace UltimateSurvival.AI
{
	public class AIGroup : MonoBehaviour 
	{
		...
		private void TrySpawn()
		{
			...
			bool nightCondition = (Enviro.EnviroManager.instance.Time.hours >= 18 && Enviro.EnviroManager.instance.Time.hours < 6) && m_SpawnMode == SpawnMode.AtNight;
			Debug.Log(nightCondition);
			bool daytimeCondition = (Enviro.EnviroManager.instance.Time.hours >= 6 && Enviro.EnviroManager.instance.Time.hours < 18) && m_SpawnMode == SpawnMode.AtDaytime;
			Debug.Log(daytimeCondition);
